...
>
__global__ __launch_bounds__(256) void attention_head_v3_dense(const __grid_constant__ AttentionParams<TMADescK, TMADescV> params) {
    ...
    constexpr uint32_t key_start = 0;
    ...
    constexpr uint32_t key_start_tile = 0;
