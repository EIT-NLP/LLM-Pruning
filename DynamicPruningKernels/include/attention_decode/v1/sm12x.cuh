...
#include "attention_decode/v1/sm12x_dense.cuh"
#include "attention_decode/v1/sm12x_boundary.cuh"
#include "attention_decode/v1/sm12x_merge.cuh"
...
struct Attention_Head_V1_Host {
    static void run(
        ...
        if (use_dense) {
            constexpr auto kernel1 = attention_head_v1_dense<
            ...
            constexpr auto kernel1 = attention_head_v1_boundary<
        ...
        if (Split > 1) {
            ...
            constexpr auto kernel2 = attention_head_v1_merge<
                kHq, kHk, kD, kNG,
                kBM, kBN,
